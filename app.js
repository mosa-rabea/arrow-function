...
let objectLit=()=>{return { key1: 'value1',key2: 'value2',key3: 'value3'}}
...
//   return [sum, product];
// };
let sumAndProduct = (a, b)=> {let sum = a + b;let product = a * b;
  return [sum, product];};
...
//  in the function declaration 'this' refers to the object 
// in the arrow function 'this' refers to the global context 
//